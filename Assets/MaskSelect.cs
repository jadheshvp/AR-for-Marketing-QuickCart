...
public class MaskSelect : MonoBehaviour
{
    ...
    public GameObject MaskMode1;
    public GameObject MaskMode2;
   ...
   // Animation w3WindowAnimation;
    ...
    public void WatchOneButtonClicked()
    {
        ...
        MaskMode1.SetActive(true);
        MaskMode2.SetActive(false);
    ...
    {
        // Show watch model on user"s Wrist
        MaskMode1.SetActive(false);
        MaskMode2.SetActive(true);
        //WatchMode3.SetActive(false);
